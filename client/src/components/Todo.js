  ...
  return (
    <div>
      ...
      <input
        ...
        //-- defaultChecked
        // DB에 있는 상태, 직접적으로 state 변경하지 않는 것에 사용
        // 컴포넌트 내부 말고, 직접 관여안하는 값
      ...
      <input
        ...
        ${item.done ? 'line-through  text-gray-500 text-opacity-70' : ''}`}
      ...
      <button
        ...
        className="text-stone-600 font-bold transition-opacity duration-300 opacity-20 hover:opacity-90
        "
      >
